...
REQUIRED_FILES=("config.json" "vocab.txt" "nemo128.onnx" "encoder-model.int8.onnx" "decoder_joint-model.int8.onnx")
...
if [ "$all_exist" = true ]; then
    echo "All model files already exist in $MODELS_DIR, skipping download."
else
